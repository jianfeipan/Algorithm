...
The Goal
Given a Binary Search Tree and a target node p, you need to find the inorder successor of that node.
...
public:
    TreeNode* inorderSuccessor(TreeNode* root, TreeNode* p) {
        ...
        while (root != nullptr) {
            // TODO: Implement the BST property logic here
            // 1. If root->val > p->val, root could be the successor. Move left.
            // 2. Otherwise, the successor must be in the right subtree. Move right.
        }
